...
PUB main
	...
	PWM_SHOULD_ECHO_PTR      := @HUB_SHOULD_ECHO
	PWM_SERVO_START_PTR      := @HUB_SERVO_0
	PWM_REC_SERVO_START_PTR  := @HUB_REC_SERVO_0

	I2C_SHOULD_ECHO_PTR      := @HUB_SHOULD_ECHO
	I2C_SERVO_0_PTR          := @HUB_SERVO_0
	I2C_REC_SERVO_0_PTR      := @HUB_REC_SERVO_0
	I2C_FIRMWARE_VERSION_PTR := @HUB_FIRMWARE_VERSION
	I2C_ROTOR_COUNT_PTR      := @HUB_ROTOR_COUNT
